...
class Ossnspider(CrawlSpider):
    ...
    rules = (
        Rule(LxmlLinkExtractor(allow_domains=allowed_domains,
                               restrict_xpaths='.//*[@id="sched-content-inner"]/div[2]/a'), callback='parse_page',
             follow=True),
        Rule(LxmlLinkExtractor(allow_domains=allowed_domains,
                               restrict_xpaths='.//*[@id="sched-content-inner"]/div[1]/div/div[*]/h2/a'),
             callback='parse_user'))
    ...
    def parse_user(self, response):
        ...
        item['title_company'] = response.xpath(
            './/*[@id="sched-page-me-profile-data"]/br/preceding-sibling::text()').extract()
        item['location'] = response.xpath(
            './/*[@id="sched-page-me-profile-data"]/br/following-sibling::text()').extract()
